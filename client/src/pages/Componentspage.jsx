...
import { TbBox, TbChevronRight, TbCode, TbCopy, TbEye, TbLayoutSidebarLeftExpand, TbMenu2, TbPackage, TbSearch, TbX } from 'react-icons/tb'
...
const Componentspage = () => {
    ...
    const publicComponents = (allcomponents || []).filter((c) => c.visibility === "public").filter((c) => c.name?.toLowerCase().includes(search.toLowerCase())).sort((a, b) => a.name.localeCompare(b.name))
...
const DetailPanel = ({ onBack, component }) => {
