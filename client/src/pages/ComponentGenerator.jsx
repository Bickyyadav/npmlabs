...
const ComponentGenerator = () => {
    ...
    const [savedComponentId, setSavedComponentId] = useState(false)
    ...
    const handleGenerate = async () => {
        ...
        try {
            const { data } = await axios.post(import.meta.env.VITE_SERVER_URL + `/api/component/generate`,
                { prompt },
    ...
    const handlePublish = async () => {
        ...
        setPublishing(true);
        try {
            await axios.post(import.meta.env.VITE_SERVER_URL + `/api/component/publish`, { componentId: savedComponentId },
                { withCredentials: true })
            setIsPublished(true);
